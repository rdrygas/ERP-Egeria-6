...
try:
    if sys.platform.startswith('win32'): # Dla systemu Windows
        oracledb.init_oracle_client(lib_dir=r"c:\instantclient_12_1") # Ścieżka do Instant Client
    elif sys.platform.startswith('linux'): # Dla systemu Linux
        oracledb.init_oracle_client(lib_dir="/opt/oracle/instantclient_12_1") # Ścieżka do Instant Client
